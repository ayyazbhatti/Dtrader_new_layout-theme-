      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-4xl max-h-[95vh] sm:max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between p-4 sm:p-6 border-b border-gray-200 dark:border-gray-700 space-y-3 sm:space-y-0">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white">Add New Group</h2>
              <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Create a new trading group with custom settings</p>
            </div>
          </div>
          <button
            onClick={handleClose}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
            ...
            <div className="sm:col-span-1">
              ...
              <input
                ...
                className={`w-full px-3 py-2 text-sm border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors duration-200 ${
                  errors.name 
            ...
            <div className="sm:col-span-1">
              ...
              {errors.priceStreamProfile && (
                <p className="mt-1 text-xs sm:text-sm text-red-600 dark:text-red-400">{errors.priceStreamProfile}</p>
              )}
            </div>
            ...
            <div className="sm:col-span-1">
              ...
              {errors.swapsDividendProfile && (
                <p className="mt-1 text-xs sm:text-sm text-red-600 dark:text-red-400">{errors.swapsDividendProfile}</p>
              )}
            </div>
            ...
            <div className="sm:col-span-1">
              ...
              {errors.assignTags && (
                <p className="mt-1 text-xs sm:text-sm text-red-600 dark:text-red-400">{errors.assignTags}</p>
              )}
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
            ...
            <div className="sm:col-span-1">
              ...
              <input
                ...
                className="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors duration-200"
              />
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-3 sm:gap-4">
            ...
            <div className="lg:col-span-3">
              ...
              <textarea
                ...
                rows={3}
                className="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors duration-200 resize-none"
              />
            </div>
            ...
            <div className="lg:col-span-1 flex items-end">
              <button
                type="submit"
                className="w-full bg-green-600 hover:bg-green-700 text-white font-medium py-2 px-4 rounded-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 text-sm sm:text-base"
              >
                Create
              </button>
            </div>
