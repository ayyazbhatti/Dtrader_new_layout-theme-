...
import { X, Save, Users, Mail, Phone, Globe, Shield, TrendingUp, Plus } from 'lucide-react'
...
interface AffiliateAddPopupProps {
  onClose: () => void
  onAdd: (user: Omit<AffiliateUser, 'id' | 'accountId' | 'joinDate' | 'lastActivity' | 'referralCount'>) => void
}

const AffiliateAddPopup: React.FC<AffiliateAddPopupProps> = ({
  onClose,
  onAdd
}) => {
      ...
      <div className="bg-gray-800 rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] overflow-hidden">
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-700">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-white">Add New Affiliate</h2>
              <p className="text-gray-400 text-sm">Create a new affiliate account</p>
            </div>
          </div>
          <button
            onClick={onClose}
...
export default AffiliateAddPopup 