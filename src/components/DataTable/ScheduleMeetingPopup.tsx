  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4">
      <div className="bg-gray-800 rounded-xl shadow-2xl max-w-6xl w-full max-h-[90vh] overflow-hidden border border-gray-700 flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto">
          {activeTab === 'schedule' ? (
            <>
              ...
              <div className="p-4 border-b border-gray-700 bg-gray-750/50">
                <h3 className="text-base font-semibold text-white mb-3">Current Call Status</h3>
                <div className="grid grid-cols-3 gap-4">
                  <div className="space-y-1.5">
                    <label className="block text-sm font-medium text-gray-300">
                      Making Call To
                    </label>
                    <div className="bg-gray-700 px-3 py-2 rounded-lg text-gray-300 text-sm border border-gray-600">
                ...
                <div className="mt-4 flex justify-end">
                  <button className="px-4 py-2 bg-red-600 text-white font-medium rounded-lg hover:bg-red-700 transition-all duration-200 shadow-lg hover:shadow-red-500/25">
                    HangUp
                  </button>
                </div>
              </div>
              ...
              <div className="p-4 space-y-6">
                ...
                <div className="space-y-3">
                  <h3 className="text-base font-semibold text-white mb-3">Call Details</h3>
                  <div className="grid grid-cols-4 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 text-sm border border-gray-600 rounded-lg bg-gray-700 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                      />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-300 mb-2">
                      ...
                      <div className="relative">
                        <input
                          ...
                          className="w-full px-3 py-2 pr-10 text-sm border border-gray-600 rounded-lg bg-gray-700 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                        />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 text-sm border border-gray-600 rounded-lg bg-gray-700 text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                      />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-300 mb-2">
                      ...
                      <div className="relative">
                        <input
                          ...
                          className="w-full px-3 py-2 pr-10 text-sm border border-gray-600 rounded-lg bg-gray-700 text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                        />
                ...
                <div className="space-y-3">
                  <h3 className="text-base font-semibold text-white mb-3">Assignment & Settings</h3>
                  <div className="grid grid-cols-3 gap-4">
                    <div>
                      <label className="block text-sm font-medium text-gray-300 mb-2">
                ...
                <div className="space-y-3">
                  <h3 className="text-base font-semibold text-white mb-3">Notifications & Status</h3>
                  <div className="grid grid-cols-4 gap-4">
                    <div>
                      <label className="block text-sm font-medium text-gray-300 mb-2">
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={3}
                      className="w-full px-3 py-2 text-sm border border-gray-600 rounded-lg bg-gray-700 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none transition-all duration-200"
                    />
                  </div>
                </div>
              </div>
            ...
            /* Call History Table */
            <div className="p-4">
              <h3 className="text-base font-semibold text-white mb-4">Call Schedule History</h3>
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead className="bg-gray-700 text-white">
                    <tr>
                      <th className="px-3 py-2 text-left font-medium border-b border-gray-600">Call Subject</th>
                      <th className="px-3 py-2 text-left font-medium border-b border-gray-600">Date & Time</th>
                      <th className="px-3 py-2 text-left font-medium border-b border-gray-600">Duration</th>
                      <th className="px-3 py-2 text-left font-medium border-b border-gray-600">Manager</th>
                      <th className="px-3 py-2 text-left font-medium border-b border-gray-600">Status</th>
                      <th className="px-3 py-2 text-left font-medium border-b border-gray-600">Created</th>
                      <th className="px-3 py-2 text-left font-medium border-b border-gray-600">Actions</th>
                    </tr>
                  </thead>
                    ...
                    {mockCallHistory.map((call) => (
                      <tr key={call.id} className="border-b border-gray-700 hover:bg-gray-700 transition-colors">
                        <td className="px-3 py-2">
                          <div className="font-medium text-white">{call.callSubject}</div>
                        </td>
                        <td className="px-3 py-2">
                          <div>{call.startDate}</div>
                          <div className="text-xs text-gray-400">{call.startTime}</div>
                        </td>
                        <td className="px-3 py-2">{call.duration}</td>
                        <td className="px-3 py-2">{call.assignToManager}</td>
                        <td className="px-3 py-2">
        ...
        {/* Footer - Fixed */}
        <div className="flex items-center justify-between gap-4 p-4 border-t border-gray-700 bg-gray-750/50 flex-shrink-0">
          ...
          <div className="flex items-center space-x-3">
            {activeTab === 'schedule' && (
              <>
                <button
                  onClick={handleClose}
                  className="px-4 py-2 text-sm font-medium text-white bg-red-600 border border-transparent rounded-lg hover:bg-red-700 transition-all duration-200 shadow-lg hover:shadow-red-500/25"
                >
                  Close
                </button>
                <button
                  ...
                  className="px-4 py-2 text-sm font-medium text-white bg-green-600 border border-transparent rounded-lg hover:bg-green-700 transition-all duration-200 shadow-lg hover:shadow-green-500/25 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-green-600"
                >
                  Add call
                </button>
              </>
            ...
            {activeTab === 'history' && (
              <button
                onClick={() => setActiveTab('schedule')}
                className="px-4 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-lg hover:bg-blue-700 transition-all duration-200 shadow-lg hover:shadow-blue-500/25"
              >
                Schedule New Call
              </button>
            )}
